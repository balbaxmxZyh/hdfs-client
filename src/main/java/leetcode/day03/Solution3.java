...
public class Solution3 {
    ...
    public int myAtoi(String s) {
        ...
        for(; i < s.length();i++){
            ...
            int pop = c-48;
            if(sum * isSf > Integer.MAX_VALUE/10 ||
                    (sum * isSf== Integer.MAX_VALUE/10 && pop * isSf > 7)){
                return Integer.MAX_VALUE;
            }
            if(sum * isSf < Integer.MIN_VALUE/10 ||
                    (sum * isSf == Integer.MIN_VALUE/10 && pop * isSf < -8)){
